...
#ifndef AUTOWARE__HELPER_UTILS__GEOMETRY__GEOMETRY_HPP_
#define AUTOWARE__HELPER_UTILS__GEOMETRY__GEOMETRY_HPP_

#include "autoware/helper_utils/geometry/boost_geometry.hpp"
#include "autoware/helper_utils/math/constants.hpp"
#include "autoware/helper_utils/math/normalization.hpp"
#include "autoware/helper_utils/ros/msg_covariance.hpp"
...
Point2d from_boost(const autoware::helper_utils::Point2d & point);

ConvexPolygon2d from_boost(const autoware::helper_utils::Polygon2d & polygon);

autoware::helper_utils::Point2d to_boost(const Point2d & point);

autoware::helper_utils::Polygon2d to_boost(const ConvexPolygon2d & polygon);
}  // namespace alt
...
#endif  // AUTOWARE__HELPER_UTILS__GEOMETRY__GEOMETRY_HPP_
