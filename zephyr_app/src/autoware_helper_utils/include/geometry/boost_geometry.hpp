...
#ifndef AUTOWARE__HELPER_UTILS__GEOMETRY__BOOST_GEOMETRY_HPP_
#define AUTOWARE__HELPER_UTILS__GEOMETRY__BOOST_GEOMETRY_HPP_
...
BOOST_GEOMETRY_REGISTER_POINT_2D(                                           // NOLINT
  autoware::helper_utils::Point2d, double, cs::cartesian, x(), y())       // NOLINT
BOOST_GEOMETRY_REGISTER_POINT_3D(                                           // NOLINT
  autoware::helper_utils::Point3d, double, cs::cartesian, x(), y(), z())  // NOLINT
BOOST_GEOMETRY_REGISTER_RING(autoware::helper_utils::LinearRing2d)        // NOLINT

#endif  // AUTOWARE__HELPER_UTILS__GEOMETRY__BOOST_GEOMETRY_HPP_
