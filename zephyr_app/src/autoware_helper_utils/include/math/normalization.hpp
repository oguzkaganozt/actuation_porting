...
#ifndef AUTOWARE__HELPER_UTILS__MATH__NORMALIZATION_HPP_
#define AUTOWARE__HELPER_UTILS__MATH__NORMALIZATION_HPP_
...
#endif  // AUTOWARE__HELPER_UTILS__MATH__NORMALIZATION_HPP_
