...
#ifndef AUTOWARE__HELPER_UTILS__ROS__MARKER_HELPER_HPP_
#define AUTOWARE__HELPER_UTILS__ROS__MARKER_HELPER_HPP_
...
visualization_msgs::msg::Marker createDefaultMarker(
  const std::string & frame_id, const int64_t now, const std::string & ns, const int32_t id,
  const int32_t type, const geometry_msgs::msg::Vector3 & scale,
  const std_msgs::msg::ColorRGBA & color);

visualization_msgs::msg::Marker createDeletedDefaultMarker(
  const int64_t now, const std::string & ns, const int32_t id);
...
#endif  // AUTOWARE__HELPER_UTILS__ROS__MARKER_HELPER_HPP_
