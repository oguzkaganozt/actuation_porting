...
public:
    ...
    , m_dds_qos(nullptr)
    {
        ...
        init_config(dds_cfg);
        fprintf(stderr, "%s -> Creating DDS domain with raw config\n", node_name_.c_str());
                            ...
                            callback_subscriber<T> callback) 
    {
        try {
            ...
            fprintf(stderr, "Error: %s -> create_subscription_dds: %s\n", 
